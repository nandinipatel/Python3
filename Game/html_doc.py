...
class Body(Tag):
    def __init__(self):
        super().__init__('body', '') #body containes will be built up separately
        self._body_contents = []
...
if __name__ == "__main__":
    ...
    # mypage.add_tag('p', 'This is a paragraph that will appear on the page')
    ...
    new_body.add_tag('p', "Unlike <strong>compsition</string>, aggregation used existing instances"
